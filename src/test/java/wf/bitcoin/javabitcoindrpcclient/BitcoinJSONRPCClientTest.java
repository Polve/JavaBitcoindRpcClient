...
public class BitcoinJSONRPCClientTest {
    ...
    @Test
    public void getEstimateSmartFee() throws Exception {
        client = new MyClientTest(false, "estimatesmartfee", null ,"{\n" +
                "  \"feerate\": 0.00050079,\n" +
                "  \"blocks\": 2\n" +
                "}\n");
        double d = client.getEstimateSmartFee(1);
        assertEquals(0.00050079, d, 0.0);
    }
}